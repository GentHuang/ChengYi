...
- (void)viewDidLoad
{
    ...
    self.vcArray = [[NSMutableArray alloc]initWithCapacity:2];
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    if (self.viewControllers.count > 0) {
        NSInteger vcIndex = (NSInteger)[self.viewControllers lastObject];
        [self.vcArray addObject:[NSNumber numberWithInteger:vcIndex]];
    }
