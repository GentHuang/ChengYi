...
- (void)createUI{
    ...
    _contentView.backgroundColor = [UIColor colorWithRed:241/256.0 green:241/256.0 blue:247/256.0 alpha:0];
    ...
    webView.opaque = NO;
    webView.backgroundColor = [UIColor colorWithRed:241/256.0 green:241/256.0 blue:247/256.0 alpha:0];
    NSString *path = [[NSBundle mainBundle] bundlePath];
    NSURL *baseURL = [NSURL fileURLWithPath:path];
    NSString * htmlPath = [[NSBundle mainBundle] pathForResource:@"about"
                                                          ofType:@"html"];
