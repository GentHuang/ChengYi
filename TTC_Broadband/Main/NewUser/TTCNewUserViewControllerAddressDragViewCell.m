//
//  TTCNewUserViewControllerAddressDragViewCell.m
//  TTC_Broadband
//
...
@interface TTCNewUserViewControllerAddressDragViewCell()
@property (strong, nonatomic) UILabel *addressLabel;
@property (strong, nonatomic) UIView *selectedBackView;
@end

@implementation TTCNewUserViewControllerAddressDragViewCell
