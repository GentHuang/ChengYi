//
//  TTCNewUserViewControllerDragView.m
//  TTC_Broadband
//
...
#import "TTCNewUserViewControllerDragViewCell.h"
@interface TTCNewUserViewControllerDragView()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate>
...
@end
@implementation TTCNewUserViewControllerDragView
...
- (void)createUI{
    ...
    [_tableView registerClass:[TTCNewUserViewControllerDragViewCell class] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    TTCNewUserViewControllerDragViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    TTCNewUserViewControllerDragViewCell *selectedCell = (TTCNewUserViewControllerDragViewCell *)[tableView cellForRowAtIndexPath:indexPath];
...
- (void)loadWithDataArray:(NSArray *)dataArray{
    ...
    for (NSString *string in dataArray) {
        if ([string isEqualToString:@"无后缀"]) {
            ...
            _addressString = (NSString *)dataArray[2];
            break;
        }else{
