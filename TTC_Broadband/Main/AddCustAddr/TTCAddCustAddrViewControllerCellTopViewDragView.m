//
//  TTCAddCustAddrViewControllerCellTopViewDragView.m
//  TTC_Broadband
//
...
#import "TTCAddCustAddrViewControllerCellTopViewDragViewCell.h"
@interface TTCAddCustAddrViewControllerCellTopViewDragView()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate>
...
@end
@implementation TTCAddCustAddrViewControllerCellTopViewDragView
...
- (void)createUI{
    ...
    [_tableView registerClass:[TTCAddCustAddrViewControllerCellTopViewDragViewCell class] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    TTCAddCustAddrViewControllerCellTopViewDragViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    TTCAddCustAddrViewControllerCellTopViewDragViewCell *selectedCell = (TTCAddCustAddrViewControllerCellTopViewDragViewCell *)[tableView cellForRowAtIndexPath:indexPath];
