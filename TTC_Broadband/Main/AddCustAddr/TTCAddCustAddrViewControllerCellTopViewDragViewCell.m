//
//  TTCAddCustAddrViewControllerCellTopViewDragViewCell.m
//  TTC_Broadband
//
...
@interface TTCAddCustAddrViewControllerCellTopViewDragViewCell()
@property (strong, nonatomic) UILabel *addressLabel;
@property (strong, nonatomic) UIView *selectedBackView;
@end

@implementation TTCAddCustAddrViewControllerCellTopViewDragViewCell
