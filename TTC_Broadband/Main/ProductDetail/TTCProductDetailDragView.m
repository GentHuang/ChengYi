...
@interface TTCProductDetailDragView()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate>
...
@implementation TTCProductDetailDragView
...
- (void)createUI{
    ...
    [_tableView registerClass:[TTCProductDetailDragViewCell class] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    TTCProductDetailDragViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
    if (_dataArray.count > 0) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    TTCProductDetailDragViewCell *selectedCell = (TTCProductDetailDragViewCell *)[tableView cellForRowAtIndexPath:indexPath];
