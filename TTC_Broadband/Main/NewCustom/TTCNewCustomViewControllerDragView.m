//
//  TTCNewCustomViewControllerDragView.m
//  TTC_Broadband
//
...
@interface TTCNewCustomViewControllerDragView()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate>
...
@end
@implementation TTCNewCustomViewControllerDragView
...
- (void)createUI{
    ...
    [_tableView registerClass:[TTCNewCustomViewControllerDragViewCell class] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    TTCNewCustomViewControllerDragViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    TTCNewCustomViewControllerDragViewCell *selectedCell = (TTCNewCustomViewControllerDragViewCell *)[tableView cellForRowAtIndexPath:indexPath];
